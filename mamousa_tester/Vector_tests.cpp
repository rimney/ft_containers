...
/*   Updated: 2023/02/20 22:56:05 by rimney           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void reverse_iterator_tests(void)
{
    ...
    /*----------------------------------*/
    /*------------ ft::reverseIterator ---------*/
    ft::reverseIterator<std::vector<int>::iterator> my_rit(v.end()), my_rit1(v.end() - 1);
    /*----------------------------------*/
    std::cout << "\033[1;37m[-------------------- [" << std::setw(40) << std::left << " copy constructor "
              << "] --------------------]\t\t\033[0m";
    {
        ft::reverseIterator<std::vector<int>::iterator> ob(my_rit);
        EQUAL(&(*my_rit) == &(*ob));
    }
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        ft::reverseIterator<std::vector<std::string>::iterator> my_rit(v.end());
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        ft::reverseIterator<std::vector<int>::iterator> my_tmp(my_rit++);
              ...
              << "] --------------------]\t\t\033[0m";
    {
        ...
        ft::reverseIterator<std::vector<char>::iterator> my_start(v.end()), my_end(v.begin());
